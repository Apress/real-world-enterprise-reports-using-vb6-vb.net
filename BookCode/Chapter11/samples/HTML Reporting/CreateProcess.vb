'
' Created by:   larryroof.com
' Company URL:  www.larryroof.com
' Client:       Dotcomments
'
' Modification History:
' Date      Description                                  Dev
' --------  -------------------------------------------  ---
' 02/17/03  initial creation                             SRP
'
' Description:
' Calls Windows API function used to launch an application.
'
